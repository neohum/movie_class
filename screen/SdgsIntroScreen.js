  ...
  return (
    <View style={styles.screen}>
      <ScrollView style={styles.scroolView}>
        ...
        <Text>
          MDGs는 유용한 개발 의제였지만 목표 범위가 너무 좁던 반면, SDGs는 더욱 포괄적이라는 점에서 MDGs보다 한층 더 발전된 의제입니다. 아울러 지속가 능발전목표(SDGs)는 다양한 국가적 상황에 따라 유연성을 발휘하므로, 각 국가들은 가장 적절하고 관련있는 목표 내 세부 목표와 지표를 골라 척도로 삼을 수 있게 되었습니다.
        </Text>
        <Text>
